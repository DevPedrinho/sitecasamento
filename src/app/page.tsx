...
export default function Home() {
  return (
    <div className="flex flex-col">
      <section className="relative flex flex-col items-center gap-8 overflow-hidden px-4 py-20 text-center sm:py-28">
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(circle_at_50%_-10%,rgba(176,141,87,0.18),transparent_55%)]"
        />
      ...
      <section className="mx-auto w-full max-w-4xl px-4 py-14 text-center sm:px-6">
        <Card className="flex flex-col items-center gap-4 p-10">
          <NotebookPen className="h-8 w-8 text-terracotta" />
